...
$curso    = "Nome do evento";
$data     = "Data/do/Evento";
$carga_h  = "Carga horas";


$texto1 = utf8_decode($empresa);
$texto2 = utf8_decode("Seu certificado pela participação no ".$curso." \n realizado em ".$data." com carga horária total de ".$carga_h.".");
$texto3 = utf8_decode(" ".utf8_encode(strftime( '%d de %B de %Y', strtotime( date( 'Y-m-d' ) ) )));
...
$messageBody = "Olá $nome<br><br>É com grande prazer que entregamos o seu certificado.<br>Ele está em anexo nesse e-mail.<br><br>Atenciosamente,<br><br>";
