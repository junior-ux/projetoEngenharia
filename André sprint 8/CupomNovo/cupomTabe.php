		...
		<table id="customers">
			...
			<?php while($exibirCupons = mysqli_fetch_array($consulta)){ ?>
                    <tr>
                        ...
                        <td><a href="javascript: if(confirm('Tem certeza que deseja deletar o cupom <?php echo $exibirCupons["nome"];?>')) location.href='delete.php?usuario=<?php echo $exibirCupons['id']; ?>';">Excluir</a>
                        </td>
                    </tr>
            <?php } ?>
