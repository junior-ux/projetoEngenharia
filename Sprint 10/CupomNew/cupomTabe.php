		...
		<table id="customers">
			...
			<?php while($exibirCupons = mysqli_fetch_array($consulta)){ ?>
                    <tr>
                        ...
                        <td><a href="javascript: if(confirm('Tem certeza que deseja DELETAR o cupom <?php echo $exibirCupons["nome"];?>')) location.href='delete.php?usuario=<?php echo $exibirCupons['id']; ?>';">Excluir</a> <a href="javascript: if(confirm('Tem certeza que deseja EDITAR o cupom <?php echo $exibirCupons["nome"];?>')) location.href='editar.php?usuario=<?php echo $exibirCupons['id']; ?>';">Editar</a>
                        </td>
                    </tr>
            <?php } ?>
