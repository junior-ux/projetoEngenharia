...
<body>
	...
	<div class="programacao">
		...
		<form method="get" action="">
			Pesquisar Locais: <input type="text" name="filtro" class="campo" required autofocus>
		...
		<div class="btn-group">
			...
			<a class="button" href="addLocal.php">Adicionar Local</a>
			<a class="button" href="tabela.php">Todos os locais</a>
		...
		<table id="customers">
			...
			<?php while($exibirLocal = mysqli_fetch_array($consulta)){ ?>
                    <tr>
                        <td><?php echo $exibirLocal["id"];?></td>
                        <td><?php echo $exibirLocal["nome"];?></td>
                        <td><a href="javascript: if(confirm('Tem certeza que deseja EXCLUIR o local <?php echo $exibirLocal["nome"];?>')) location.href='delete.php?usuario=<?php echo $exibirLocal['id']; ?>';">Excluir</a>
						</td>
                    </tr>
            <?php } ?>
