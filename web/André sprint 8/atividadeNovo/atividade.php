                ...
                <form nome="programacao" action="processa.php" method="post">
                    <fieldset>
                        ...
                        <div class="campo">
                            ...
                            <select name="local" style="width: 20em">
                                <?php 
                                    $sql = "SELECT * FROM ta_local ORDER BY id";
                                    $salvar = mysqli_query($conexao, $sql);
                                 ?>
                                 <?php while($vreg = mysqli_fetch_row($salvar)){ ?>

                                       <option value= <?php $vreg[1] ?>><?php echo $vreg[1]; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="campo">
                            ...
                            <select name="convidado" style="width: 20em">
                                <?php 
                                    $sql = "SELECT * FROM ta_convidado ORDER BY id";
                                    $salvar = mysqli_query($conexao, $sql);
                                 ?>
                                 <?php while($vreg = mysqli_fetch_array($salvar)){ ?>

                                       <option value= <?php $vreg['nome'] ?>><?php echo $vreg['nome']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
