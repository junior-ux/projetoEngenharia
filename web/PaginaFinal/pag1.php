...
<!-- <<<<<<< HEAD -->
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><h1>PageUp</h1></a>
                    </li>
    ...
    <div class="container">
        ...
        <div class="col-12 text-center my-5">
            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Nome palestrante</h4>
                            <p class="card-text">Universidade Federal de Ouro Preto (UFOP)</p>

                        </div>
                        <div class="card-body">
                            <a href="#" class="card-link" data-toggle="modal" data-target="#siteModal1">Mais
                                Informações</a>
                            <a href="#" class="card-link" data-toggle="modal" data-target="#siteModal11">Atividades</a>
                        </div>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="#" class="card-link" data-toggle="modal" data-target="#siteModal2">Mais
                                Informações</a>
                            <a href="#" class="card-link" data-toggle="modal" data-target="#siteModal22">Atividades</a>
                        </div>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="#" class="card-link" data-toggle="modal" data-target="#siteModal3">Mais
                                Informações</a>
                            <a href="#" class="card-link" data-toggle="modal" data-target="#siteModal33">Atividades</a>
                        </div>
            ...
            <div class="card text-left my-5">
                <h5 class="card-header">Dia 1</h5>
                <div class="card-body">
                    <h5 class="card-title">Abertura</h5>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <a  href="#" class="card-link" data-toggle="modal" data-target="#modalInfo11">Mais Informações</a>
                </div>
                <a id= "lul"></a>
                <div class="card-body">
                    <h5 class="card-title">Palestra Motivacional</h5>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <a href="#" class="card-link" data-toggle="modal" data-target="#modalInfo12">Mais Informações</a>
                </div>
            </div>

            <!-- Modal Info11 -->  
            <div class="modal fade" id="modalInfo11" tabindex="1" role="dialog">
            ...
            <!-- Modal Info12 -->
            <div class="modal fade" id="modalInfo12" tabindex="1" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Mais Informações</h5>
            ...
            <div class="card text-left my-5">
                <h5 class="card-header">Dia 2</h5>
                <div class="card-body">
                    <h5 class="card-title">Abertura</h5>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <a href="#" class="card-link" data-toggle="modal" data-target="#modalInfo21">Mais Informações</a>
                </div>
                <a id= "lul"></a>
                <div class="card-body">
                    <h5 class="card-title">Palestra Motivacional</h5>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <a href="#" class="card-link" data-toggle="modal" data-target="#modalInfo22">Mais Informações</a>
                </div>
            </div>

            <!-- Modal Info2 -->
            <div class="modal fade" id="modalInfo21" tabindex="1" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
            ...
            <!-- Modal Info12 -->
            <div class="modal fade" id="modalInfo22" tabindex="1" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Mais Informações</h5>
            ...
            <div class="card text-left my-5">
                <h5 class="card-header">Dia 3</h5>
                <div class="card-body">
                    <h5 class="card-title">Abertura</h5>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <a href="#" class="card-link" data-toggle="modal" data-target="#modalInfo31">Mais Informações</a>
                </div>
                <a id= "lul"></a>
                <div class="card-body">
                    <h5 class="card-title">Palestra Motivacional</h5>
                    <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <a href="#" class="card-link" data-toggle="modal" data-target="#modalInfo32">Mais Informações</a>
                </div>
            </div>

            <!-- Modal Info3-->
            <div class="modal fade" id="modalInfo31" tabindex="1" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
            ...
            <!-- Modal Info32 -->
            <div class="modal fade" id="modalInfo32" tabindex="1" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Mais Informações</h5>
            ...
            <div class="modal fade" id="siteModal1" tabindex="1" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title">Informações do Palestrante</h5>
                            <button type="button" class="close" data-dismiss="modal">
                                <span>&times;</span>
                            </button>
