...
$sql = "insert into usuarios (codigoCupom, desconto, quantidade, validade) values ('$codigo', '$desconto', '$quantidade', '$validade')";
...
<body>
    ...
    <body>
        ...
        <form name="cupom" action="processa.php" method="POST" action="">
            ...
            <?php
                if($linhas == 1){
                    print "Cupom inserido com sucesso!";
                }else{
                    print "Cupom NÃO inserido.<br>Já existe um cupom com esse nome!";
                }
            ?>

            <a href="tabela.php" class="boton">Voltar</a>
