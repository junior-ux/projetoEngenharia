...
<body>
	...
	<div class="programacao">
		...
		<form method="get" action="">
			Pesquisar atividade: <input type="text" name="filtro" class="campo" required autofocus>
		...
		<table id="customers">
			...
			<?php while($exibirAtividade = mysqli_fetch_array($consulta)){ ?>
				<tr>
					...
					<td><a href="javascript: if(confirm('Tem certeza que deseja EXCLUIR a Atividade <?php echo $exibirAtividade["nome"];?>')) location.href='delete.php?usuario=<?php echo $exibirAtividade['id']; ?>';">Excluir</a>
					</td>
				</tr>
			<?php } ?>
		</table>
