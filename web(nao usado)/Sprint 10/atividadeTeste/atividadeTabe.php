...
$sql = "select * from ta_atividade where nome like '%$filtro%'";
...
<body>
	...
	<div class="programacao">
		...
		<form method="get" action="">
			Pesquisar atividade pelo titulo: <input type="text" name="filtro" class="campo" required autofocus>
		...
		<div class="btn-group">
			...
			<a class="button" href="addAtividade.php">Adicionar Atividade</a><br>
		...
		<table id="customers">
			...
			<?php while($exibirAtividade = mysqli_fetch_array($consulta)){ ?>
				<tr>
					<td><?php echo $exibirAtividade["id"];?></td>
					<td><?php echo $exibirAtividade["nome"];?></td>
					<td><?php echo $exibirAtividade["lugar"];?></td>
					...
					<td><?php echo $exibirAtividade["palestrante"];?></td>
					<td><?php echo $exibirAtividade["valor"];?></td>
					<td><a href="javascript: if(confirm('Tem certeza que deseja EXCLUIR a Atividade <?php echo $exibirAtividade["nome"];?>')) location.href='delete.php?usuario=<?php echo $exibirAtividade['id']; ?>';">Excluir</a>  <a href="javascript: if(confirm('Tem certeza que deseja EDITAR a Atividade <?php echo $exibirAtividade["nome"];?>')) location.href='editar.php?usuario=<?php echo $exibirAtividade['id']; ?>';">Editar</a>
					</td>
				</tr>
			<?php } ?>
		</table>
