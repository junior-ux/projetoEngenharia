        ...
        <form name="inscricao" action="processamento.php" method="POST" action="">
            ...
            <div class="form-row">
                <div class="form-group col-md-2.1">
                    ...
                    <input id="inicio" name="dataI" placeholder="DD/MM/AAAA" class="form-control input-md" required="required" type="date" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
                </div>

                <div class="form-group col-md-1.5">
                    <label for="exampleFormControlSelect1">Horas<h11>*</h11></label>
                    <input id="horaI" type="time" name="horaI" placeholder="00:00" class="form-control input-md" required="" type="text" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
                </div>

                <div class="form-group col-md-2.1">
                    <label for="exampleFormControlSelect1">Fim do evento<h11>*</h11></label>
                    <input id="termino" name="dataT" placeholder="DD/MM/AAAA" class="form-control input-md" required="" type="date" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
                </div>

                <div class="form-group col-md-1.5">
                    <label for="exampleFormControlSelect1">Horas<h11>*</h11></label>
                    <input id="horaT" type="time" name="horaT" placeholder="00:00" class="form-control input-md" required="required" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input id="cidade" name="cidade" placeholder="" class="form-control input-md" required="" type="text" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-3">
                    <label for="exampleFormControlSelect1">Responsavel</label>
                    <input id="responsavel" name="responsavel" placeholder="" class="form-control input-md" required="" type="text" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
                </div>
