...
<body>
    <div class="ini">
        <div class="barra">
            ...
            <a href="../loginAdm/loginmenu.html" class="evento">Criar Evento</a>
                    ...
                    <div class="home-content">
                        ...
                        <div class="login-form">
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    <a href="../../telaadm.html">
                                        <button type="submit" name="entrar" class="bt">Entrar </button></a>
                            ...
                            <p class="text-center small">Não tem uma conta! <a href="../cadastroadm/cadastroadm.html">Cadraste-se</a>.</p>
                            </div>
